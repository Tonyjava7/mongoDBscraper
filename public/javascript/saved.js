function displaySaved() {
    $.getJSON("/saved/all", function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var mainDiv = $("<div>");
            mainDiv.addClass("card grey lighten-2").attr("id", "main-" + data[i]._id);
            ...
            var p = $("<p>");
            p.text(data[i].summary).attr("id", "summary-" + data[i]._id);
            ...
            var button = $("<a>");
            button.addClass("waves-effect waves-light white btn create-note modal-trigger").attr("data-id", data[i]._id).attr("data-target", "notes").text("Create Notes");
            var deleteArticle = $("<a>");
            deleteArticle.addClass("waves-effect waves-light white btn delete-button").attr("id", data[i]._id).text("Delete");
            var byline = $("<p>");
            byline.text(data[i].byline);
            cardActionDiv.append(byline).append(button).append(deleteArticle);
